        ...
        <div class="history-card">
            ...
            <div class="history-body">
                <div class="history-filters">
                    <input type="date" class="form-control" id="dateFilter" style="max-width: 200px;" onchange="loadHistoryFromDatabase()">
                    <select class="form-control" id="statusFilter" style="max-width: 200px;" onchange="loadHistoryFromDatabase()">
                    ...
                    <input type="text" class="form-control" id="routeNameFilter" placeholder="Filter by route..." style="max-width: 200px;" onchange="loadHistoryFromDatabase()">
                </div>
...
<div id="reasonModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 3000; justify-content: center; align-items: center;">
    <div style="background: white; border-radius: 12px; padding: 28px; max-width: 450px; width: 90%; box-shadow: 0 10px 40px rgba(0,0,0,0.3);">
        ...
        <div style="display: flex; gap: 12px;">
            ...
            <button id="reasonModalCancel" style="flex: 1; padding: 11px; border-radius: 6px; border: 1px solid #ddd; background: #f8f9fa; color: #666; font-weight: 700; font-size: 12px; cursor: pointer; text-transform: uppercase; letter-spacing: 0.5px;">Cancel</button>
        </div>
    </div>
</div>

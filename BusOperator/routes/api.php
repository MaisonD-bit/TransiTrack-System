...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('drivers')->group(function () {
        ...
        Route::post('/{driverId}/location', [DriverController::class, 'postLocation']);
    });
    ...
    Route::get('commuter/active-ticket', [CommuterRoutesController::class, 'activeTicket']);
    ...
    Route::get('payments/maya/checkout/{checkoutId}/status', [MayaController::class, 'checkoutStatus']);
});

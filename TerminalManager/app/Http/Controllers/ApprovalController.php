...
class ApprovalController extends Controller
{
    ...
    public function pending(Request $request, int $id)
    {
        ...
        // Verify manager can only deactivate operators from their terminal
        if ($terminal && $operator->terminal !== $terminal) {
            return response()->json(['success' => false, 'message' => 'Unauthorized: You cannot deactivate operators from other terminals'], 403);
        }

...
return new class extends Migration
{
    ...
    {
        Schema::create('terminal_occupancy_history', function (Blueprint $table) {
            $table->id();
            
            // Space reference
            $table->string('space_id');
            $table->foreign('space_id')->references('space_id')->on('terminal_spaces')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('terminal_occupancy_history');
    }
};
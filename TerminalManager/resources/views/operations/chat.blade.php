...
<div class="container-fluid p-4" data-api-key="{{ $streamApiKey }}" data-user-id="{{ $userId }}" data-user-token="{{ $streamToken }}" data-user-name="{{ $userName }}" data-stream-unavailable="@json($streamUnavailable ?? false)">
